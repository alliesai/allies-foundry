...
WEB_GRACEFUL_TIMEOUT="${WEB_GRACEFUL_TIMEOUT:-300}"
WEB_MAX_REQUESTS="${WEB_MAX_REQUESTS:-10000}"
WEB_MAX_REQUESTS_JITTER="${WEB_MAX_REQUESTS_JITTER:-1000}"
